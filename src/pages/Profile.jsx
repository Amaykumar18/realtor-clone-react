    ...
    <>
      <section className="max-w-6xl mx-auto flex justify-center items-center flex-col">
        ...
        <div className="w-full md:w-[50%] mt-6 px-3 ">
          <form >
            ...
            disabled className="mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white
             ...
             <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg mb-6">
              ...
              <p onClick={onLogOut} className="text-blue-500 hover:text-blue-700 transition ease-in-out 
          ...
          <FcHome className="mr-2 text-3xl bf-red-200 rounded-full p-1 border-2 "/>
