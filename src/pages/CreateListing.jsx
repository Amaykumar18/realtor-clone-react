        ...
        <form>
            ...
            <div className="flex">
                <button type="button" id="type" value="sale" onClick={onChange} className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow:lg active:shadow-lg transition duration-150 ease-in-out w-full ${
                 ...
                 <button type="button" id="type" value="sale" onClick={onChange} className={`ml-3 backdrop:px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow:lg active:shadow-lg transition duration-150 ease-in-out w-full ${
            ...
            focus:text-gray-800 focus:bg-white focus:border-slate-600 mb-6"/>
            <div className="flex space-x-6 mb-6 ">
                <div>
                   ...
                   focus:bg-white focus:border-slate-700 text-center "
                   />
                </div>
                <div>
            ...
            <div className="flex">
                <button type="button" id="parking" value={ true } onClick={onChange} className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow:lg active:shadow-lg transition duration-150 ease-in-out w-full ${
                 ...
                 <button type="button" id="parking" value={false} onClick={onChange} className={`ml-3 backdrop:px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow:lg active:shadow-lg transition duration-150 ease-in-out w-full ${
                    parking  ? "bg-white text-black" :"bg-slate-600 text-white"
                }`}>No</button>
            </div>
            ...
            <div className="flex">
                <button type="button" id="furnished" value={true} onClick={onChange} className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow:lg active:shadow-lg transition duration-150 ease-in-out w-full ${
                 ...
                 <button type="button" id="furnished" value={false} onClick={onChange} className={`ml-3 backdrop:px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow:lg active:shadow-lg transition duration-150 ease-in-out w-full ${
                    furnished ? "bg-white text-black" :"bg-slate-600 text-white"
                }`}>No</button>
            </div>
            ...
            border-gray-300 rounded 
              transition duration-150 ease-in-out
            focus:text-gray-800 focus:bg-white focus:border-slate-600 "/><p className="text-lg mt-6 font-semibold"></p>
            ...
            <button type="button" id="offer" value={true} onClick={onChange} className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow:lg active:shadow-lg transition duration-150 ease-in-out w-full ${
                 ...
                 <button type="button" id="offer" value={false} onClick={onChange} className={`ml-3 backdrop:px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow:lg active:shadow-lg transition duration-150 ease-in-out w-full ${
                    offer ? "bg-white text-black" :"bg-slate-600 text-white"
                }`}>No</button>
            </div>
            ...
            <div className="mb-6">
                ...
                multiple required className="w-full px-3 py-1.5 text-gray-700 bg-white border border-gray-300 rounded
                transition duration-150 ease-in-out focus:bg-white focus:border-slate-600" />
                
            </div>
            <button type="submit" className="mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800
            active:shadow-lg transition duration-150 easi-in-out">Create Listing</button>
        </form>
    </main>
  );
}
